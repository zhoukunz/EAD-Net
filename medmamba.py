...
class PatchEmbed2D(nn.Module):
    ...
    def __init__(self, patch_size=4, in_chans=14, embed_dim=96, norm_layer=None, **kwargs):
        super().__init__()
...
class VSSM(nn.Module):
    def __init__(self, patch_size=4, in_chans=14, num_classes=1000, depths=[2, 2, 4, 2], depths_decoder=[2, 9, 2, 2],
...
medmamba_t = VSSM(depths=[2, 2, 4, 2], dims=[96, 192, 384, 768], num_classes=3).to("cuda")
medmamba_s = VSSM(depths=[2, 2, 8, 2], dims=[96, 192, 384, 768], num_classes=3).to("cuda")
